...
class ShoeDepthEstimator:
    ...
    def estimate(self, history: Iterable[Any]) -> ShoeDepthEstimate:
        ...
        progress = min(1.0, max(0.0, hand_count / max(1.0, float(self.target_hands))))
        depth_reliability = min(0.85, 0.55 + 0.30 * progress)
